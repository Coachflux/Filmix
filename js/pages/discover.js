...
const DiscoverPage = {
    ...
    renderPagination(current, total) {
        ...
        let html = `
            <button class="page-btn" onclick="DiscoverPage.changePage(${current - 1})" ${current <= 1 ? 'disabled' : ''}>
        ...
        html += `
            <button class="page-btn" onclick="DiscoverPage.changePage(${current + 1})" ${current >= total ? 'disabled' : ''}>
    ...
    updateFilterLabels(type) {
        ...
        const tvFilters = ['discover', 'todayTrending', 'thisWeekTrending', 'popular', 'onTheAir', 'topRated'];
        const movieFilters = ['discover', 'todayTrending', 'thisWeekTrending', 'popular', 'nowPlaying', 'upcoming', 'topRated'];
        const tvLabels = ['Discover', 'Trending Today', 'Trending Week', 'Popular', 'On The Air', 'Top Rated'];
